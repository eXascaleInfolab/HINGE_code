...
REAL relation_filter_reci_rank = 0, relation_filter_rank = 0, relation_filter_tot = 0, relation3_filter_tot = 0, relation1_filter_tot = 0;
...
void initTest() {
    ...
    relation_filter_reci_rank = 0, relation_filter_rank = 0, relation_filter_tot = 0, relation3_filter_tot = 0, relation1_filter_tot = 0;
}
extern "C"
...
extern "C"
void getRelationBatch(INT *ph, INT *pt, INT *pr) {
    for (INT i = 0; i < relationTotal; i++) {
        ph[i] = testList[lastRelation].h;
        pt[i] = testList[lastRelation].t;
        pr[i] = i;
    }
}
...
extern "C"
void testRelation(REAL *con) {
    INT h = testList[lastRelation].h;
    INT t = testList[lastRelation].t;
    INT r = testList[lastRelation].r;
    REAL minimal = con[r];
    INT relation_s = 0;
    INT relation_filter_s = 0;
    ...
    if (relation_filter_s < 10) relation_filter_tot += 1;
    // if (relation_s < 10) relation_tot += 1;
    if (relation_filter_s < 3) relation3_filter_tot += 1;
    // if (relation_s < 3) relation3_tot += 1;
    if (relation_filter_s < 1) relation1_filter_tot += 1;
    // if (relation_s < 1) relation1_tot += 1;

    relation_filter_rank += (1+relation_filter_s);
    // relation_rank += (1+relation_s);
    relation_filter_reci_rank += 1.0/(1+relation_filter_s);
    // relation_reci_rank += 1.0/(1+relation_s);
...
void test_link_prediction() {
    ...
    relation_filter_reci_rank /= testTotal;
    relation_filter_rank /= testTotal;
    relation_filter_tot /= testTotal;
    relation3_filter_tot /= testTotal;
    relation1_filter_tot /= testTotal;
    ...
    printf("\n\n********************************************************************************************************\n");
    printf("head (filter):\t\t %f \t %f \t %f \t %f \t %f \n", l_filter_reci_rank, l_filter_rank, l_filter_tot, l3_filter_tot, l1_filter_tot);
    printf("tail (filter):\t\t %f \t %f \t %f \t %f \t %f \n", r_filter_reci_rank, r_filter_rank, r_filter_tot, r3_filter_tot, r1_filter_tot);
    printf("relation (filter):\t\t %f \t %f \t %f \t %f \t %f \n", relation_filter_reci_rank, relation_filter_rank, relation_filter_tot, relation3_filter_tot, relation1_filter_tot);
    printf("averaged h,t,r (filter):\t %f \t %f \t %f \t %f \t %f \n", (l_filter_reci_rank+r_filter_reci_rank+relation_filter_reci_rank)/3, (l_filter_rank+r_filter_rank+relation_filter_rank)/3, (l_filter_tot+r_filter_tot+relation_filter_tot)/3, (l3_filter_tot+r3_filter_tot+relation3_filter_tot)/3, (l1_filter_tot+r1_filter_tot+relation1_filter_tot)/3);
    printf("********************************************************************************************************\n\n\n");
