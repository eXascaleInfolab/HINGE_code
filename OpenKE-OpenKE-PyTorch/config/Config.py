...
class Config(object):
    def __init__(self):
        ...
        self.lib.getRelationBatch.argtypes = [
            ctypes.c_void_p,
            ctypes.c_void_p,
            ctypes.c_void_p,
        ]
        ...
        self.lib.testRelation.argtypes = [ctypes.c_void_p]
    ...
    def link_prediction(self):
        ...
        for i in range(self.testTotal):
            ...
            self.lib.getRelationBatch(self.test_h_addr, self.test_t_addr, self.test_r_addr)
            res = self.test_one_step(
                self.testModel, self.test_h, self.test_t, self.test_r
            )
            self.lib.testRelation(res.__array_interface__["data"][0])
