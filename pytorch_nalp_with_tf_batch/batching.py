...
def Batch_Loader(train_i_indexes, train_i_values, n_values, n_roles, role_val, batch_size, arity, whole_train_facts, indexes_values, indexes_roles, new_negative_sampling_h_and_t, roleH2roleT, new_batching_method, num_negative_samples, dataset_without_h_and_t):
    ...
    # print("new_facts_indexes:", new_facts_indexes)
    # print("new_facts_indexes[:last_idx, :]:", new_facts_indexes[:last_idx, :])
    # print("new_facts_values:", new_facts_values)
    # print("new_facts_values[:last_idx]:", new_facts_values[:last_idx])
    if new_batching_method=='True':
